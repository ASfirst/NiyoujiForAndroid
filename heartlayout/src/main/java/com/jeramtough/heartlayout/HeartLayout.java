 ...
 */
package com.jeramtough.heartlayout;
...
public class HeartLayout extends RelativeLayout
{
	...
	private void init(AttributeSet attrs, int defStyleAttr)
	{
		...
		final TypedArray a = getContext()
				.obtainStyledAttributes(attrs, R.styleable.HeartLayout, defStyleAttr, 0);
	...
	public void addHeartWithRandomColor()
	{
		Random mRandom = new Random();
		addHeart(Color.rgb(mRandom.nextInt(255), mRandom.nextInt(255), mRandom.nextInt(255)));
	}
